...
hi Normal ctermbg=Black ctermfg=Gray cterm=NONE guibg=Black guifg=White gui=none
...
"hi CursorLine ctermbg=DarkGray guibg=Gray15 gui=none
  hi CursorLine ctermbg=DarkGray guibg=bg gui=none
"  hi CursorColumn ctermbg=DarkGray guibg=Gray15 gui=none
  " only for Win32, IME status
  if has('multi_byte_ime')
    hi CursorIM guibg=Purple guifg=NONE gui=none
  endif
  ...
  " Tab colors {{{2
  if has("windows")
    hi TabLine ctermbg=DarkYellow ctermfg=bg cterm=NONE guibg=Gray20 guifg=#ffcc66 
    hi TabLineFill ctermbg=DarkYellow ctermfg=bg cterm=NONE guibg=Gray20 guifg=#ffcc66
...
hi WarningMsg ctermbg=bg ctermfg=Red cterm=NONE guibg=bg guifg=#ff3333 
...
hi Question ctermbg=bg ctermfg=White cterm=NONE guibg=bg guifg=White 
...
if has("diff")
  ...
  hi DiffChange ctermbg=Blue ctermfg=fg cterm=NONE guibg=Magenta guifg=bg gui=none
...
hi LineNr ctermbg=Gray ctermfg=Black guibg=DarkGray guifg=bg gui=none
if has("folding")
...
"  hi Folded ctermbg=bg ctermfg=DarkCyan cterm=NONE guibg=Gray10 guifg=Violet gui=none
  hi Folded ctermbg=bg ctermfg=DarkCyan cterm=NONE guibg=Gray10 guifg=Cyan gui=none
  hi FoldColumn ctermbg=bg ctermfg=Cyan cterm=NONE guibg=Gray10 guifg=Violet gui=none
endif
if has("signs")
...
hi SpecialKey ctermbg=bg ctermfg=DarkGray guibg=bg guifg=#555555  gui=none
...
if has("windows")
  hi StatusLineNC ctermbg=DarkYellow ctermfg=bg cterm=NONE guibg=Gray20 guifg=#ffcc66 
endif
...
"  hi Visual ctermbg=Yellow ctermfg=bg cterm=NONE guibg=#ffffcc guifg=bg gui=none
  hi Visual ctermbg=Yellow ctermfg=bg cterm=NONE guibg=#bb77ee guifg=bg gui=none
...
hi Constant ctermbg=bg ctermfg=Blue guibg=bg guifg=Magenta gui=bold
hi link Number Constant
hi link Float Constant
hi link Boolean Constant

" xmlの色決定
hi Identifier ctermbg=bg ctermfg=Cyan guibg=bg guifg=#99ffcc gui=none
hi Function ctermbg=bg ctermfg=Green guibg=bg guifg=Orange gui=none
...
hi PreCondit ctermbg=bg ctermfg=Blue guibg=bg guifg=#cc66dd gui=bold
...
hi MatchParen ctermbg=fg ctermfg=bg cterm=bold guibg=bg guifg=fg gui=bold
