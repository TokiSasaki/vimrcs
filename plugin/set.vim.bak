...
set mousemodel=popup_setpos
set makeprg=~/Work/Cyg64/bin/make.exe
...
"クリップボードを利用できないので注意
vnoremap	<silent>	<C-p>	"_c<c-r>+<esc>
vnoremap	<silent>	p		"_c<c-r>+<esc>
vnoremap	<silent>	P		"_c<c-r>+<esc>
vnoremap	<silent>	<C-v>	"_c<c-r>+<esc>
...
" 設定ファイル
if has('win32')
command! Vset		:call OpenFile(expand('$VIM/_vimrc'))
command! Gset		:call OpenFile(expand('$VIM/_gvimrc'))
else
